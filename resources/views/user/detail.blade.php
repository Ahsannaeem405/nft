                                    ...
                                    <div class="row">
                                        <div class="col-2" style="text-align: center; padding: unset;">
                                            {{-- <img style="width: 100%; border-radius: 50%;object-fit: contain;object-position: center center;"
                                                ...
                                                <img style="width: 100%; object-fit: contain;object-position: center center;" src="@if(isset($data1->large_image_url)) {{ $data1->large_image_url}} @else  https://helostatus.com/wp-content/uploads/2021/09/HD-WhatsApp-profile.jpg @endif  " alt="">
                                        </div>
                                            ...
                                            <div style="  padding: 15px; background: #f9f9f9;border-radius: 12px;">
                                                <div class="row">
                                                    <div class="col-8">
                                                        ...
                                                        <h5 style="    margin-bottom: 3px;">${{ $data1->stats->one_day_sales}}</h5>
